...
const DogBodyMap = ({ onMark, initialMarker,  readOnly = false }) => {
    const { selectedPart, clickPoint, handleClick } = useBodyMap(onMark, initialMarker, readOnly);
    ...
    return (
        ...
        >
            ...
            <path
                ...
                fill={selectedPart === "LEG" ? "black" : "black"}
